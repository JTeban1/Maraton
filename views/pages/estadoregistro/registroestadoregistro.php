...
<div class="d-flex justify-content-center text-center py-5">
          ...
          <?php
               ...
               $registroEstadoRegistro = ControladorEstadoRegistro::ctrRegistroEstaRegis();
 
 
 
               if($registroEstadoRegistro == "ok")
               {
                    echo '<script>
                    ...
                    echo '<div class="alert alert-success">Estado de Registro </div>';

                      ...
                      <tr>
                        ...
                        <td>
                            ...
                            <div class="btn-group">
                              ...
                              <a href="index.php?pages=/registroevento/actualizarRegistroevento&RegistroID=<?php echo $value["RegistroID"]; ?>" class="btn btn-warning"><i class="fas fa-pencil-alt"></i>Editar</a>

                              </div>

                              <form method="post">

                                  <input type="hidden" value="<?php echo $value["RegistroID"]; ?>" name="eliminarRegistroEvento">
